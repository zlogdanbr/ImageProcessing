...
MyFrame::MyFrame():wxFrame(NULL, -1, "My SkeletonApp", wxPoint(-1, -1))
{
    ...
    auto menuItemAlgo1= menuAlgo->Append(ALGO1, "Detect &Faces\tCTRL+F", "Detects Faces");

    menuAlgo->AppendSeparator();
    auto menuItemAlgo2 = menuAlgo->Append(ALGO2, "Detect &Eyes\tCTRL+E", "Detects Eyes");
...
void MyFrame::OnOpen(wxCommandEvent& event)
{
    wxFileDialog openFileDialog(    this,
                                    ...
                                    wxEmptyString, 
                                    wxEmptyString, 
                                    "Text Files (*.jpg)|*.jpg|All Files (*.*)|*.*", wxFD_OPEN | wxFD_FILE_MUST_EXIST);
